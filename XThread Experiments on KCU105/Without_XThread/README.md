...
Creating SoC Design with All Components:
  ...
  12. click right click on block design -->  ip catalog --> select ip files which you created with HLS(1 core and 1 control_unit)
...
When generate bitstream finished, export hardware (choose include bitstream option) and open Vitis 2020.1.
  ...
  7. Ready to run.
  8. Record execution time only one thread.
