...
void INIT(volatile int *control_unit, int core_number, int instruc_type, int mech_address){
...
void TALK(volatile int *control_unit, int core_number, int instruc_type, int mech_address, volatile int *ack, float *mem){
